...
SWEP.PrintName				= "Battery"		-- Weapon name (Shown on HUD)	
...
SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/items/battery.mdl", bone = "v_weapon.c4", rel = "", pos = Vector(-6.415, -1.28, -4.731), angle = Angle(-180, 86.217, 144.38), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["box"] = { type = "Model", model = "models/items/battery.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(1.968, 2.089, 0.061), angle = Angle(-153.489, 13.88, -103.243), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
