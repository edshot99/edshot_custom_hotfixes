...
SWEP.PrintName				= "Buckshot"		-- Weapon name (Shown on HUD)	
...
SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/items/boxbuckshot.mdl", bone = "v_weapon.c4", rel = "", pos = Vector(-3.441, 1.126, -2.646), angle = Angle(-44.974, 95.374, 0), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["box"] = { type = "Model", model = "models/items/boxbuckshot.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(1.968, 1.019, 0.495), angle = Angle(-90, 90, 0), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
if CLIENT then return end
function SWEP:PrimaryAttack()
	self.Owner:GiveAmmo( "10", "Buckshot" )
--	self.Owner:SetArmor( self.Owner:Armor() + 15 )
	self:Remove()
end